...
import {
 FormElementInstance,
 FormElements,
} from "@/app/(dashboard)/builder/[id]/_components/FormElements";
...
function FormSubmitComponent({
 ...
 return (
  <div className="flex justify-center w-full h-full items-center px-8 py-12  flex-col">
   <h2 className="truncate font-bold text-5xl  text-center text-white my-8">
    {name}
   </h2>
   <div
    key={renderKey}
