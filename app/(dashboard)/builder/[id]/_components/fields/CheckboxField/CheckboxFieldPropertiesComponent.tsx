...
import { CheckboxFieldCustomInstance, CheckboxFieldPropertiesSchema } from "./CheckboxFieldFormElement";
import { z } from "zod";
...
type propertiesFormSchemaType = z.infer<typeof CheckboxFieldPropertiesSchema>;
export default function CheckboxFieldPropertiesComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
