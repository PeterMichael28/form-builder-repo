...
type propertiesFormSchemaType = z.infer<typeof SelectFieldPropertiesSchema>;
export default function SelectFieldPropertiesComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
